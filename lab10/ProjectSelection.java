...
public class ProjectSelection {
	...
	int Selection(int[][] rGraph, int[][] graph, int s, int t, int cut_cap, Project[] nodes) { 
		...
		System.out.println (" The following are edges from reachable verteces from source after removing the added vertices (selected projects/blocks):");
		...
		if (selProjects.size() > 0) {
			System.out.print("Selected Projects/Blocks are: ( " + String.valueOf(selProjects.get(0)));
